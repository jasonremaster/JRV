<?php
    ...
    class Ticket extends Conectar{
        ...
        public function insert_ticket($usu_id,$cat_id,$cats_id,$tick_titulo,$tick_descrip,$prio_id,$sem_id){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="INSERT INTO tm_ticket (tick_id,usu_id,cat_id,cats_id,tick_titulo,tick_descrip,tick_estado,fech_crea,usu_asig,fech_asig,prio_id,est,sem_id) VALUES (NULL,?,?,?,?,?,'Abierto',now(),NULL,NULL,?,'1',?);";
        ...
        public function listar_ticket_x_usu($usu_id,$sem){
            require_once("../models/Semestre.php");
            $semestre = new Semestre();
            $sem_act= $semestre->get_semestre_activo();
            if($sem == ''){
                $sem = $sem_act;
            }
            $conectar= parent::conexion();
        ...
        public function filtrar_ticket($tick_titulo,$cat_id,$prio_id,$sem_id){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="call filtrar_ticket_1(?,?,?,?)";
            $sql=$conectar->prepare($sql);
