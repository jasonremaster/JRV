<?php
    ...
    switch($_GET["op"]){
        ...
        case "insert":
            $datos=$ticket->insert_ticket($_POST["usu_id"],$_POST["cat_id"],$_POST["cats_id"],$_POST["tick_titulo"],$_POST["tick_descrip"],$_POST["prio_id"], $sem_act);
        ...
        case "listar_x_usu":
            $datos=$ticket->listar_ticket_x_usu($_POST["usu_id"],$_POST["sem"]);
            $data= Array();
            foreach($datos as $row){
                $sub_array = array();
        ...
        case "listar_filtro":
            $datos=$ticket->filtrar_ticket($_POST["tick_titulo"],$_POST["cat_id"],$_POST["prio_id"],$_POST["sem_id"]);
            $data= Array();
            foreach($datos as $row){
                $sub_array = array();
                $sub_array[] = $row["tick_id"];
