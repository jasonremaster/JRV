	...
	<div class="page-content">
		<div class="container-fluid">
			...
			<div class="box-typical box-typical-padding">
				...
				<p>
				Para trámites de caracter personal adjunte fotografía de su cédula.
				</p>
				...
				<div class="row">
					<form method="post" id="ticket_form">
						...
						<input type="hidden" id="sem_id" name="sem_id" value="<?php echo $semestre ?>">
