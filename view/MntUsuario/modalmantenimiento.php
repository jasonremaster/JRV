        ...
        <div class="modal-content">
            ...
            <form method="post" id="usuario_form">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="form-label" for="usu_telf">Cedula</label>
                        <input type="number" min="0" max="9999999999" class="form-control" id="usu_telf" name="usu_telf" placeholder="Ingrese Cédula"  required>
                    </div>
