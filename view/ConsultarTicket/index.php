...
$sem=new Semestre();
$semestre=$sem->get_semestre_activo();
echo $semestre;
...
<body class="with-side-menu">
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <a id="activo" name="activo"><?php echo $semestre?> </a>
            <div class="box-typical box-typical-padding">
                <div class="row" id="viewuser">
                    ...
                    <div class="col-lg-2">
                        <fieldset class="form-group">
                            ...
                            <select class="select2" name="cat_id" id="cat_id" data-placeholder="Seleccionar">
                    ...
                    <div class="col-lg-2">
                        <fieldset class="form-group">
                            ...
                            <select class="select2" name="prio_id" id="prio_id" data-placeholder="Seleccionar">
                                <option label="Seleccionar"></option>
                            </select>
                        </fieldset>
                    </div>
                    <div class="col-lg-2">
                        <fieldset class="form-group">
                            ...
                            <select class="select2" name="sem_id" id="sem_id" data-placeholder="Seleccionar">
                                <option label="Seleccionar"></option>
                            </select>
                        </fieldset>
                    </div>
                ...
                <div class="row" id="viewuser2">

                    <div class="col-lg-4">
                            <fieldset class=" form-group">
                        <label class="form-label" for="sem">Ver Tickets por Semestre</label>
                        <select class="select2" name="sem" id="sem" data-placeholder="Seleccionar">
                            <option label="Seleccionar"></option>
                        </select>
                        </fieldset>
                    </div>
                    ...
                    <div class="col-lg-2">
                        <fieldset class="form-group">
                            <label class="form-label" for="btnsem">&nbsp;</label>
                            <button type="submit" class="btn btn-rounded btn-primary btn-block"
                                id="btnsem">Filtrar</button>
                        </fieldset>
                    </div>

                    <div class="col-lg-2">
                        <fieldset class="form-group">
                            <label class="form-label" for="btnactual">&nbsp;</label>
                            <button class="btn btn-rounded btn-primary btn-block" id="btnactual">Semestre Actual</button>
                        </fieldset>
                    </div>
                </div>
            </div>
